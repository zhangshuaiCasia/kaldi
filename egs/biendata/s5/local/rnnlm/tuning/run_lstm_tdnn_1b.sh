...
dir=exp_train_dev_sp/rnnlm_lstm_tdnn_1b
embedding_dim=800
lstm_rpd=200
lstm_nrpd=200
...
ac_model_dir=exp_train_dev_sp/chain/tdnn7q
ngram_order=3
...
text=data/train_dev/text_noid.gz
