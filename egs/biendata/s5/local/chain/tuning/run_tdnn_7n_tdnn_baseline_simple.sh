...
if [ $stage -le 12 ]; then
  ...
  relu-batchnorm-layer name=tdnn2 $opts input=Append(0,3) dim=512
  ...
  relu-batchnorm-layer name=tdnn4 $opts input=Append(0,3) dim=512
  linear-component name=tdnn5l dim=512 $linear_opts
  relu-batchnorm-layer name=tdnn5 $opts dim=512 input=Append(0,3)
