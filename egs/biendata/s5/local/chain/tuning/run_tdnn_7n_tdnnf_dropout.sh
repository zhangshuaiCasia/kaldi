...
if [ $stage -le 12 ]; then
  ...
  output_opts="l2-regularize=0.0005 bottleneck-dim=160"
  ...
  linear-component name=tdnn2l dim=160 $linear_opts input=Append(-1,0)
  relu-batchnorm-layer name=tdnn2 $opts input=Append(0,1) dim=512
  linear-component name=tdnn3l dim=160 $linear_opts
  relu-batchnorm-layer name=tdnn3 $opts dim=512
  linear-component name=tdnn4l dim=160 $linear_opts input=Append(-1,0)
  relu-batchnorm-layer name=tdnn4 $opts input=Append(0,1) dim=512
  linear-component name=tdnn5l dim=160 $linear_opts
  relu-batchnorm-layer name=tdnn5 $opts dim=512 input=Append(tdnn5l, tdnn3l)
  linear-component name=tdnn6l dim=160 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn6 $opts input=Append(0,3) dim=512
  linear-component name=tdnn7l dim=160 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn7 $opts input=Append(0,3,tdnn6l,tdnn4l,tdnn2l) dim=512
  linear-component name=tdnn8l dim=160 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn8 $opts input=Append(0,3) dim=512
  linear-component name=tdnn9l dim=160 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn9 $opts input=Append(0,3,tdnn8l,tdnn6l,tdnn4l) dim=512
  linear-component name=tdnn10l dim=160 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn10 $opts input=Append(0,3) dim=512
  linear-component name=tdnn11l dim=160 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn11 $opts input=Append(0,3,tdnn10l,tdnn8l,tdnn6l) dim=512
  linear-component name=prefinal-l dim=160 $linear_opts
...
if [ $stage -le 14 ]; then
  ...
  # the lang directory.
  utils/mkgraph.sh --self-loop-scale 1.0 data_all_phaseI/lang_test $dir $dir/graph_7n
fi
