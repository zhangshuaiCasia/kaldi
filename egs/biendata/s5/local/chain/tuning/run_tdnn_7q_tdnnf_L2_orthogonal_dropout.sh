...
get_egs_stage=-10
speed_perturb=false
affix=7q_tdnnf_L2_orthogonal_dropout
...
if [ $stage -le 12 ]; then
  ...
  affine_opts="l2-regularize=0.01 dropout-proportion=0.1 dropout-per-dim=true dropout-per-dim-continuous=true"
  tdnnf_opts="l2-regularize=0.01 dropout-proportion=0.1 bypass-scale=0.66"
