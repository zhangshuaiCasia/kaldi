...
if [ $stage -le 12 ]; then
  ...
  # relu-batchnorm-layer name=tdnn5 $opts dim=1280 input=Append(0,1)
  ...
  # relu-batchnorm-layer name=tdnn7 $opts input=Append(0,3) dim=1280
  # linear-component name=tdnn8l dim=256 $linear_opts input=Append(-3,0)
  # relu-batchnorm-layer name=tdnn8 $opts input=Append(0,3) dim=1280
  # linear-component name=tdnn9l dim=256 $linear_opts input=Append(-3,0)
  # relu-batchnorm-layer name=tdnn9 $opts input=Append(0,3) dim=1280
  # linear-component name=tdnn10l dim=256 $linear_opts input=Append(-3,0)
  # relu-batchnorm-layer name=tdnn10 $opts input=Append(0,3) dim=1280
  # linear-component name=tdnn11l dim=256 $linear_opts input=Append(-3,0)
  # relu-batchnorm-layer name=tdnn11 $opts input=Append(0,3) dim=1280
  ...
  relu-batchnorm-layer name=tdnn5  dim=1280 input=Append(-1,0)
  ...
  relu-batchnorm-layer name=tdnn7  input=Append(0,3) dim=1280
  ...
  relu-batchnorm-layer name=tdnn9  input=Append(0,3) dim=1280
  ...
  relu-batchnorm-layer name=tdnn11  input=Append(0,3) dim=1280
