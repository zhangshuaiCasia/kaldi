...
get_egs_stage=-10
speed_perturb=false
dir=exp_all_phaseI/chain/tdnn_7k_1  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_nj=10
...
if [ $stage -le 14 ]; then
  ...
  # the lang directory.
  utils/mkgraph.sh --self-loop-scale 1.0 data_all_phaseI/lang_test $dir $dir/graph_7k
fi


graph_dir=$dir/graph_7k
iter_opts=
